...
//    public static long    CLICK_QUIT_FULLSCREEN_TIME = 0;
    ...
    public void init(Context context) {
        ...
        startButton = (ImageView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.start);
        fullscreenButton = (ImageView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.fullscreen);
        progressBar = (SeekBar) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.progress);
        currentTimeTextView = (TextView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.current);
        totalTimeTextView = (TextView) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.total);
        bottomContainer = (ViewGroup) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.layout_bottom);
        textureViewContainer = (ViewGroup) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.surface_container);
        topContainer = (ViewGroup) findViewById(fm.jiecao.jcvideoplayer_lib.R.id.layout_top);
    ...
    public void onClick(View v) {
        ...
        } else if (i == fm.jiecao.jcvideoplayer_lib.R.id.surface_container && currentState == CURRENT_STATE_ERROR) {
