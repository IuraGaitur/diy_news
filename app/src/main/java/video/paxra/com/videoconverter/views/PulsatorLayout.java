...
public class PulsatorLayout extends RelativeLayout {
  ...
  public PulsatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    // get attributes
    TypedArray attr =
        context.getTheme().obtainStyledAttributes(attrs, R.styleable.Pulsator4Droid, 0, 0);
    ...
    try {
      ...
      mInterpolator =
          attr.getInteger(R.styleable.Pulsator4Droid_pulse_interpolator, DEFAULT_INTERPOLATOR);
    } finally {
      attr.recycle();
    }
