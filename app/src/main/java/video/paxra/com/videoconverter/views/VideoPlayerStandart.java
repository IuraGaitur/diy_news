 ...
 * On 2016/04/18 16:15
 */
public class VideoPlayerStandart extends VideoPlayer {
    ...
    public VideoPlayerStandart(Context context) {
        super(context);
    }

    public VideoPlayerStandart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//                    }
    ...
    public void refreshCache() {
        if (pauseSwitchCoverBitmap != null) {
            VideoPlayerStandart jcVideoPlayer = ((VideoPlayerStandart) JCVideoPlayerManager.getFirst());
